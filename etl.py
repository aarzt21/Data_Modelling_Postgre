...
def process_song_file(cur, filepath):
    """
    This function takes in json files, and inserts the records into songs and artists tables.
...
def process_log_file(cur, filepath):
    """
    This function takes in json files, and inserts the records into songplay tables.
...
def process_data(cur, conn, filepath, func):
    """
    This function takes in json files and inserts records to provided tables
    
    Args:
        cur: database cursor.
        conn: database connection  
        filepath: file location.
        func: file function that does the processing 
    Returns:
        None
    """
